              ...
              <div className="col-md-4 col-sm-4 col-xs-12 menulinks" key={index}>
                ...
                <ul>
                  ...
                  {menu.links && menu.links.map((link, idx) => {
                    if (link.url === "https://www.rhvacations.ae") {
                      return (
                        <>
                          <li key={idx}>
                            <a href={link.url} target='_blank' style={{ color: 'inherit', fontSize: '14px', lineHeight: '23px', textDecoration: "none" }}>{link.name}</a>
                          </li>
                        </>
                      )
                    } else {
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-sm-6 col-xs-12">
              {logo && <img src='images/Yellow-RH-Logo.png' className="logo img-responsive my-1" alt="R and H logo" width="200px" />}

              <div className="col-md-12 h-20 mt-2" id="iconsdiv" style={{ paddingLeft: 0,}} >
