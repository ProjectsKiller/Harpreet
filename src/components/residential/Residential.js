...
const Residential = () => {
      ...
      return (
        <div className="col-md-3 mb-12">
          ...
          <div className="card" id="main-div-card">
            {/* <img onClick={Singleproperty} id={item.PropertyID} className="card-img-top" src={items} alt="Card image cap" style={{ height: '210px' }} /> */}
            <img onClick={Singleproperty} id={item.PropertyID} className="card-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrO9L064TtmrRBRYlx5lh0nXfR5m8EsA7VNw&usqp=CAU" alt="Card cap" style={{ height: '210px' }} />
            ...
            <div className="card-body" style={{ padding: '27px 27px 0px 27px' }}>
              ...
              <div className="additional-details mt-4" style={{ marginBottom: '30px' }}>
                ...
                <div className="bed details mt-2">
                  <img  alt="top-looks" src="/images/bed.JPG" className="mr-2 -mt-1" />{item.No_of_Rooms}
                  <span id="spacing">|</span>
                </div>

                <div className="bathtub details mt-2">
                  <img  alt="top-looks" src="/images/bathtub.JPG" className="mr-2 -mt-1" />{item.No_of_Bathroom}
                  <span id="spacing">|</span>
                </div>

                <div className="squre-ft details mt-2">
                  <img  alt="top-looks" src="/images/square.JPG" className="mr-1" />
  ...
  return (
    <div className="mt-0 p-12" id="salemaindiv">
      <h3 id="pro-heading">Residential Properties in Dubai</h3>
